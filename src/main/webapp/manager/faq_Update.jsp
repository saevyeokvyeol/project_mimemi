	        ...
	        onsubmit='return checkValid()' enctype="multipart/form-data">
		        ...
		        <table class="table table-borderless faq-table">
		              <tr>
                          <th>제목</th>
                          <td>
                          	<span><input type="text" class="form-control" name="faq_title" value="${faq.faqTitle}" maxlength='16'></span> 
                          </td>
                      </tr>
					    <tr>
                            <th>카테고리</th>
                         ...
                         <tr>
                            <th>내용</th>
                            <td>
                                <textarea class="form-control" name="faq_content" cols="50" rows="10" maxlength='333' placeholder="내용을 입력해 주세요." >${faq.faqContent}</textarea>
                            </td>
                         </tr>
                         <tr>
                            <th>첨부파일</th>
	                            <td>
	                               <div class="faq-image-insert-area"> 
					                	<input type="file" class="form-control"  id="faq-image-selector" name="file" accept=".jpg, .jpeg, .png" >
	                                	<p id="file-status">${faq.faqAttach}</p>
	                                    <div class="faq-image-preview">
	                                        <img id="faq-image-output" src="${path}/img/${faq.faqAttach}">
	                                    </div>
	                                    <script>
				...
				<div class="faq-submit-button">
				    <input type="submit" class="btn btn-outline-dark"  value="FAQ 수정">
				    <span class="btn btn-outline-dark"><a href="${path}/front?key=faq&methodName=selectAllFaq">목록</a></span>
			        <span class="btn btn-outline-dark"><a href="${path}/front?key=faq&methodName=delete&faqNo=${faq.faqNo}">삭제</a></span>
