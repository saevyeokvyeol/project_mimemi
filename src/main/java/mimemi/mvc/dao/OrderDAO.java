...
public interface OrderDAO {
	...
	/**
	 * 배송 스케줄 생성
	 * @param: OrderDeliDTO(int orderLineCode, int orderStateId, String orderDeliDate)
	...
	/**
	 * 배송 일자 수정
	 * @param: int orderDeliId, String orderDeliDate
	...
	/**
	 * 배송 주문 상태 변경
	 * @param: int orderDeliId, int orderStateId
	 * @return: int(수정된 스케줄 수)
	 * */
	int updateDeliState(int orderDeliId, int orderStateId) throws SQLException;
